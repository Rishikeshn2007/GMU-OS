...
; Original MikeOS copyright and license are retained unchanged.
;
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute GMU OS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of GMU OS, and', 0
